				...
				<div class="row container-grid nf-col-3">
					...
					<div class="nf-item branding coffee spacing">
						<div class="item-box">
							...
							<div class="link-zoom">
								<a href="project-details.php" class="project_links same_style"> <i class="fa fa-link"> </i> </a>
					...
					<div class="col-lg-4">
						<div class="img-scale">
							...
							<div class="latest__block-post gray-bg">
								...
								<h3 class="latest__block-title"><a href="blog-single.php">How To Decorate With Black-and-White?</a></h3>
